<template>
  <div class="container mt-[80px]">
    ...
    <div class="grid grid-cols-[411px_821px] gap-10 relative">
      <div>
        <Splide
          ref="splideFirstRef"
          :has-track="false"
          :options="options"
          class="w-[411px] h-[474px] overflow-hidden rounded-2xl"
        >
      ...
      <div class="mt-[108px]">
        <Splide ref="splideSecondRef" :has-track="false" :options="options" class="">
          <SplideTrack class="">
            <SplideSlide
              class="grid grid-cols-[607px_175px] gap-10 items-end"
              v-for="(item, index) of info"
              :key="index"
            >
              <div class="space-y-14">
                ...
                <div class="space-y-[28px]">
                  <div class="tm text-[26px] text-[#27292A] tracking-[3%]">
                    {{ item.text }}
                  </div>
                  <div class="flex items-center justify-between">
                    <p class="text-[#546B81] tr text-2xl tracking-[3%]">- {{ item.author }}</p>
              ...
              <div class="w-[175px] h-[220px] overflow-hidden rounded-2xl relative">
                <img
